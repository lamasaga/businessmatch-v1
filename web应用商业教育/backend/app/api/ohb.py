...
from app.models.ohb import OneCompany, AIEmployee, AITask, CompanyStage, EmployeeStatus, TaskStatus
from app.schemas.ohb import (
...
router = APIRouter(prefix="/ohb", tags=["OHB - 一人公司"])
