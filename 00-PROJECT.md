...
| **学生 · 在线匹配** | **Matchmaking** | **真人随机匹配**进同一局；空位由 **AI 选手填补**（Q1=B） | 🔴 未实现；属 Phase A+ 新产品能力 |
...
| **商业模拟体验 · 练习赛** | **营内对抗赛** Group Scrimmage | **营团内**由学生或教师发起；**真人 + AI 填位**；非正式赛、非个人日常（Q2） | 🔴 待定义 API/`match_kind` |
...
| **比赛控场** | 正式赛、营内赛发起与控场 | A ✅ / 营内对抗 🔴 |
| **教研工作台** | 选题库、教案、练习题准备 → 发布到营课 | B～C 🔴 |
| **学情与复盘** | Plutus 看板 + 班级复盘汇总 | B 🔴 |
...
| 能力 | Phase |
|------|-------|
| 营内对抗 + 在线匹配 + AI 填位 | A 闭环后 **A+**（需 ADR/术语登记） |
| Hermes / Plutus / 复盘 | B |
| 教师端教研工作台 | B～C |
| 拟真城市跨局 World | C+ |
| OPC 主路径 | E |
