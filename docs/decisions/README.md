...
| **M2** | 引入或更换**核心依赖/框架**（ORM、状态管理、编排框架等） | 选用 LangGraph 做 Athena |
...
| ID | 标题 | 状态 | 日期 | 一句话 |
|----|------|------|------|--------|
| [001](./001-文档约束层与蓝图编程.md) | 文档约束层与蓝图编程 | 已采纳 | 2026-05-21 | 00～09 + 规则文件为权威锚点，代码是文档产物 |
...
| [009](./009-赛季模式与教师端双端演进.md) | 赛季模式与教师端双端演进 | **草案** | 2026-05-29 | 教师端+赛季容器；`match_kind` T2/T1 规划，Phase A 仍 `official` |
