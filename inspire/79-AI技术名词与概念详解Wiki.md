...
> **文档定位**：商域 BizSim Edu 在 [81-六支柱全景](./81-商域AI赋能六支柱全景.md)、[77-投资人版](./77-商域AI草案.md)、[78-Vibe Coding 实施指南](./78-智能体技术路线批判与VibeCoding实施指南.md) 及全仓智能体规划中出现的 **AI / Agent / 教学产品名词** 的**统一释义**；每项含：通俗解释、在本项目中的含义、代码/文档落点、阶段状态、易混淆项。
>
...
| **见 also** | [77 §一](./77-商域AI草案.md)、[78 §一](./78-智能体技术路线批判与VibeCoding实施指南.md) |
...
| 文档 | 本 Wiki 用法 |
|------|----------------|
| [77-](./77-商域AI草案.md) | 看到名词 → 来 79 查**准确定义与是否已落地** |
