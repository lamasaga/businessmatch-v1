# 商业模拟教育平台 · 生涯模式：大循环、家园与资源经济

> **文档定位**：Career Mode（生涯模式）的**当前产品权威设计稿**——在 Arena 商赛之外，承载用户长期成长、拟真小店/家族经营、NPC 与故事线，以及「搜打撤 / Roguelite」式局外积累。工程契约见 [`webapp/backend/app/domains/career/DESIGN.md`](../../../webapp/backend/app/domains/career/DESIGN.md)。
>
> **关联**：[01-一体化平台总体规划](./01-一体化平台总体规划.md) · [03-生涯模式与激励闭环](./03-生涯模式与激励闭环.md) · [02- §5.0](../../02-赛事体系与双端产品.md) · [07-拟真城市](../../07-拟真城市与区域模拟-阅读合集.md) · [64-双循环](../../64-双循环与多层级游戏设计理念.md) · [53-局外成长](../../53-游戏化与局外成长设计.md) · [67-叙事嵌入](../../67-叙事在商业模拟中的嵌入方法.md)
>
> **最后更新**：2026-05-23
...
| **World（07-）** | 城市母本供 **城市橱窗**槽位、区域足迹、叙事地名 | Phase B 静态引用；Phase C 运行时注入 |
| **OPC（05-）** | **终局出口 A**：真实/半真实首项目 | 不替代生涯主线；OPC 解锁可引用生涯等级，非 Phase B 范围 |
| **拟真城市（07-）** | **终局出口 B**：共享城市 POP | 生涯「城市足迹」与 07 城市 ID 对齐 |

### 1.3 设计硬约束

1. **教育公平**：`match_kind=official` 的局内 **零数值加成**（见 [53- §4.1](../../53-游戏化与局外成长设计.md)）；局外成长以信息、工具、叙事、外观、剧本解锁为主。
...
　　理论详述见 [64-双循环与多层级游戏设计理念](../../64-双循环与多层级游戏设计理念.md)。本平台映射如下：
...
| 日软上限 | XP 沿用 [03- §3.3](./03-生涯模式与激励闭环.md)；T2 对局次数可设班级级上限 |
...
　　**不用**轻科幻星图为主包装（见 [53- §5.1](../../53-游戏化与局外成长设计.md) 备选）；主叙事为：
...
**区域足迹**：在 Career Profile 记录「曾参与过的 `city_id`」与最佳名次，供主页地图点亮（Phase C 与 World 域联动）。
...
- **局内叙事**：对局结束生成「决策生长」摘要（[67-](../../67-叙事在商业模拟中的嵌入方法.md)），不编造与数据矛盾的剧情；
...
| 工作项 | 验收 |
|--------|------|
| Persona 测评 + 赛制推荐 | 与 [15-](../../f早期调研/15-性格分类框架-理论综述.md) 对齐 |
...
*下一篇（激励细则）：[03-生涯模式与激励闭环.md](./03-生涯模式与激励闭环.md)*
