...
> **文档定位**：根目录 **06-** — Career Mode（生涯模式）的**产品权威设计稿**。在 Arena 商赛之外，承载长期成长、拟真小店/家族经营、NPC 与故事线，以及「搜打撤 / Roguelite」式局外积累。赛季模式是生涯的**主线剧情**，日常模式是**长草期养成**。
>
...
>
> **关联**：[01-平台愿景](01-平台愿景与产品架构.md) · [02- §5.0 / §六 赛季](02-赛事体系与双端产品.md) · [07-拟真城市](07-拟真城市与区域模拟-阅读合集.md)（World 终局，与本文 **06-** 不同） · [inspire/81-AI 六支柱](inspire/81-商识唯智AI赋能六支柱全景.md)（支柱①教练 · 支柱②生涯 NPC） · [inspire/64-双循环](inspire/64-双循环与多层级游戏设计理念.md) · [inspire/53-局外成长](inspire/53-游戏化与局外成长设计.md) · [inspire/67-叙事嵌入](inspire/67-叙事在商业模拟中的嵌入方法.md)
>
> **最后更新**：2026-05-29
...
- **赛季模式**：参与教师开设的课程赛季，按节奏完成活动，体验"主线剧情"。赛季有明确目标、教师引导、里程碑验收，是生涯成长的**加速器**。
- **日常模式**：无赛季时的平淡体验，自由练习、Quest、图谱、家园。是"长草期"式的无压力积累，维持日常活跃度。
...
| **T3a** | T2 班级正式赛 | 教师端赛季 → 邀请码加入                    | `official_t2`    | 高权重 XP、**荣誉**、赛季分      | 教师组织    | 局外仅 cosmetic |
| **T3b** | T1 级别正式赛 | 平台报名 + 资质审核                      | `official_t1`    | 最高权重 XP、**荣誉**、认证、限定叙事 | 主办单位    | 局外仅 cosmetic |


　　与 [02- §7.0](02-赛事体系与双端产品.md) 对照：`game_config_id` 决定**规则包**（如国内/美国赛、练习/正式 YAML）；`match_kind` 决定**办赛流程与 XP 权重**。
...
| T2 班级正式赛对局     | T3a | 100–300（高权重）  | honor + 参与         |
| T2 班级赛前三名      | T3a | +100          | honor bonus        |
| T1 级别正式赛对局     | T3b | 150–400（最高权重） | honor + 认证         |
| T1 正式赛前三名      | T3b | +150          | honor bonus + 限定外观 |
| 家园槽升级          | —   | —             | 消耗 supplies        |
...
| 失败保底  | T2/T3a/T3b 末位仍获得 **≥30%** 基础物资与完整复盘卡                                 |
| 家长/教师 | 可选时长提醒（远期小程序）                                                        |


### 3.5 赛季经验反馈

　　赛季结束时，赛季内所有活动经验通过 `SettlementBundle` 统一结算并汇入 Career Hub。


| 结算项               | 来源             | 汇入生涯           |
| ----------------- | -------------- | -------------- |
| **XP**            | 赛季全部活动（T0～T3a） | 直接累加，推动等级      |
| **荣誉（honor）**     | T3a 班级赛排名      | 赛季榜 + 生涯荣誉累计   |
| **物资（supplies）**  | 赛季活动参与 + 里程碑完成 | 家园槽升级消耗        |
| **建材（materials）** | T2 练习赛         | 家园槽升级消耗        |
| **赛季分**           | 赛季综合表现         | 影响 Legacy 可选传承 |
| **NPC 好感度**       | 赛季中与 NPC 互动    | 解锁 NPC 章节      |


　　赛季结算后，学生获得**赛季档案**（Season Portfolio）：包含参与的活动列表、最佳表现、五维雷达变化、教师评语。档案永久保留，可分享。

　　赛季档案与日常记录的区别：

- **赛季档案**：有教师引导、有里程碑、有排名，是"主线剧情"的见证。
- **日常记录**：自由探索的零散积累，是"养成"的痕迹。
...
1. 五维雷达初形；`showcase` 绑定南京；
2. 每日练习赛、Quest、图谱推进，积累 supplies 与 materials；
3. 等待教师开设新赛季（推送通知）。
...
| 周   | 教师端                   | 学生端              | 生涯产出               |
| --- | --------------------- | ---------------- | ------------------ |
| 1   | 开营团 → 发邀请码 → 开赛季      | 加入营团 → 进入赛季主页    | 赛季进度条启动            |
| 2   | 推送 T0 理论课 + T1 Quest  | 完成课程 + 每日 Quest  | trust + supplies   |
| 3   | 推送 T2 练习赛（简化规则）       | 参与练习赛，熟悉机制       | materials + XP     |
| 4   | 推送复盘活动 + 产出作业         | 提交复盘报告           | trust + NPC 好感     |
| 5   | 推送 T2 练习赛（完整规则）       | 参与完整练习赛          | materials + XP     |
| 6   | 推送理论课（进阶概念）           | 完成进阶课程           | trust + 学识点        |
| 7   | 推送 T2 练习赛（对抗赛）        | 参与对抗，积累策略        | materials + XP     |
| 8   | **赛季收官**：组织 T3a 班级正式赛 | 参与 T2 班级赛 → 查看排名 | honor + 赛季分 + 赛季档案 |
| 赛后  | 发布全班复盘 + 作业评价         | 查看赛季档案 → 经验汇入生涯  | Legacy 可选传承        |
...
- 小循环 / 大循环对应到具体页面与活动
- T0～T3 产出、消耗、公平性清晰
- MVP 含家园槽 + NPC 占位；列出明确不做项
- 与 Arena 域边界、现有 `xp_events` 一致
