...
| **10** | [四赛制匣子开发与集成指导](./10-四赛制匣子开发与集成指导.md) | 四赛制 Monorepo、平台挂载、双轨 TechVenture、演示部署 |
...
| 开发 | `08-` AI_DEFAULT → `09-` §6.1 · `10-`（四赛制）· docs/decisions |
...
　　**编写代码时的事实依据**：`00～10`（尤其 `08-`），不以 `inspire/` 为准。打开项目后的**导航入口**为 [agent.md](./agent.md)。
