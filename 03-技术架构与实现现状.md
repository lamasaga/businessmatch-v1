...
| 层 | 技术 |
|----|------|
| 前端 | React 19、TypeScript、Vite 8、Tailwind、Zustand、React Router 7；局内美术规划见 [inspire/76-](./inspire/76-商赛美术资源嵌入与技术选型建议.md)（`game-assets` manifest，Phase A+） |
...
| Career/生涯 | `06-` + `01-` §三 + `career/DESIGN` + `08-` §2.7 |
| 商赛 UI/美术 | `inspire/76-` + `02-` + `inspire/b/00-` + `08-` §2.2 前端矩阵 |
| OPC | `05-` + `03-` §八 + `OPC/02-` |
| 智能体 | `03-` §八 全节 + `05-` §六 |
| 全局架构 | `00-` + `03-` + `09-` + `docs/decisions/README.md` |
| 推翻/争议旧架构 | 相关 `docs/decisions/00N-*.md` + `adr-writing.mdc` |
